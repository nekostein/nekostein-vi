...
\setmainfont[Numbers=Monospaced]{NewComputerModern10}
\setromanfont[Numbers=Monospaced]{NewComputerModern10}
\setsansfont[Numbers=Monospaced,BoldFont={Inter-Bold.otf}, ItalicFont={Inter-Italic.otf},BoldItalicFont={Inter-BoldItalic.otf}]{Inter}
